...
public abstract class ExpandableField extends Field
{
	...
	protected ExpandableField(String id,
							  ...
							  Integer maxEntries)
	{
		super(id, name, explanation, usage, type, style, allowEmpty, datatype, restrictions);
		this.growthDirection = Objects.requireNonNullElse(growthDirection, FieldOrientation.HORIZONTAL);
