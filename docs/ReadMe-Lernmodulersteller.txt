...
2. Modellieren des Lernmoduls
   ...
   - Hinweis: das LeMoS validiert nicht gegen diese Schemata, daraus ergibt sich folgendes:
     - Sollte ein Fehler im Schema vorliegen, sodass etwas fälchlicherweise als inkorrekt klassifiziert wird, kann das LeMoS die Konfiguration ggf. dennoch verarbeiten
...
4. Bereitstellen des Lernmoduls
   - Lokales Testen des generierten Lernmoduls in mindestens einer der folgenden Varianten:
     - Via Apache:
       - Verschieben der enpackten ZIP-Datei an den gewünschten Document-Root
